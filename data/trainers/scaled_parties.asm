...
CCCData:
	db $FF, 81, RAICHU, 80, DUGTRIO, 81, NIDOQUEEN, 80, TAUROS, 81, CHARIZARD, 88, BEEDRILL, 0

KAYData:
	db $FF, 78, HITMONLEE, 79, GYARADOS, 81, STARMIE, 80, CHARIZARD, 80, BLISSEY, 79, RATICATE, 0
	
BBBBBaData:
	db $FF, 80, MEW, 81, KANGASKHAN, 79, JYNX, 87, SANDSLASH, 79, NIDOKING, 78, CHARIZARD, 0

ASHData:
	db $FF, 80, GYARADOS, 79, ARBOK, 78, ONIX, 78, VILEPLUME, 88, JABETTA, 79, HYPNO, 0
	
RocketAData:
	db $FF, 85, PHANCERO, 83, MAGNETON, 82, FLAREON, 82, GYARADOS, 82, CROBAT, 81, RATICATE, 0
