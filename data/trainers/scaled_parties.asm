...
KrisData:
	db $FF, 100, ELECTABUZZ, 100, CLEFABLE, 100, POLIWRATH, 100, SCIZOR, 100, ALAKAZAM, 100, KANGASKHAN, 0

CCCData:
	db $FF, 100, RAICHU, 100, DUGTRIO, 100, NIDOQUEEN, 100, TAUROS, 100, CHARIZARD, 100, BEEDRILL, 0

KAYData:
	db $FF, 100, HITMONLEE, 100, GYARADOS, 100, STARMIE, 100, CHARIZARD, 100, BLISSEY, 100, RATICATE, 0
	
BBBBBaData:
	db $FF, 100, MEW, 100, KANGASKHAN, 100, JYNX, 100, SANDSLASH, 100, NIDOKING, 100, SEAKING, 0

ASHData:
	db $FF, 100, GYARADOS, 100, ARBOK, 100, STEELIX, 100, VILEPLUME, 100, JABETTA, 100, HYPNO, 0
	
RocketAData:
	db $FF, 100, PHANCERO, 100, MAGNETON, 100, FLAREON, 100, GYARADOS, 100, CROBAT, 100, RATICATE, 0
